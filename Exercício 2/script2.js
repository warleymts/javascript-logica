...
const player2 = {
  ...
  life: parseInt(prompt("Insira um valor de vida de 1 a 100:")),
  defense: parseInt(prompt("Insira um valor de defesa de 1 a 100:")),
  shield: prompt(
    "Seu personagem possui escudo? Responda S ou N:"
  ).toUpperCase(),
};
...
alert(
  `O dano que ${player1.name} causou à ${player2.name} é igual a: ${damage}.`
);
